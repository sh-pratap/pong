# Pong
A simple pong clone made using python and pygame. 

### How to Run
Make sure to have `python` installed and then clone the repo. The create a *virtual environment* with `python -m venv venv` and then activate it. 
